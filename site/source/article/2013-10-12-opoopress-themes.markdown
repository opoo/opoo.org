...
**TP** - *关键字：HTML5, CSS3, Bootstrap, Web font*
...
三种主题都使用了 Google Web Font 来美化页面中的英文字符，**TP**主题还使用自定义的字体作为界面中的图标。使用 Web Font 作为图标的方式似乎大有取代 glyphicons 的趋势。这个在今后可能单独讨论一下。 
