<div id="navbar" class="navbar">
  <div id="top-nav">
    ...
    <#assign isCategories = isCategories!false == true>
    <#if isCategories>
    ...
    <ul class="action-bar horizontal-list">
        ...
        <li class="actions-item -tooltip" title="<@s 'OpooPress - a java based static blog generator'/>">
         ...
         <li class="actions-item -tooltip" title="<@s 'SSL link'/>">
            <a href="https://opoo.org${root_url}${page.url}"><i class="tp-post-type smallmedium lock">&nbsp;</i></a>
        </li>
        
        <li class="actions-item -tooltip" title="<@s 'My GitHub'/>">
            <a href="https://github.com/opoo" target="_blank"><i class="tp-post-type smallmedium github">&nbsp;</i></a>
        </li>
        <li class="actions-item -tooltip" title="<@s 'My Twitter'/>">
            <a href="https://twitter.com/alexlincn" target="_blank"><i class="tp-post-type smallmedium twitter">&nbsp;</i></a>
        </li>

        <li class="actions-item -tooltip" title="<@s 'My Email'/>">
            <a href="mailto:opoo@users.sf.net" rel="nofollow"><i class="tp-post-type smallmedium email">&nbsp;</i></a>
        </li>
